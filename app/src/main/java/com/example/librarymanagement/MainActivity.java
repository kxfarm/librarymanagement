...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        auth.signInWithEmailAndPassword(edtEmail.getText().toString(), edtPassword.getText().toString())
                                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                                    ...
                                    public void onSuccess(AuthResult authResult) {
                                        startActivity(new Intent(MainActivity.this, UserUI.class));
                                        finish();
                                    }
        ...
        private void showRegisterDialog(){
            ...
            final MaterialEditText edtNic = register_layout.findViewById(R.id.edtNic);
            ...
            dialog.setPositiveButton("REGISTER", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if(TextUtils.isEmpty(edtNic.getText().toString())){
                        Snackbar.make(rootLayout,"Please enter your NIC number",Snackbar.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    auth.createUserWithEmailAndPassword(edtEmail.getText().toString(),edtPassword.getText().toString())
                            .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                                ...
                                public void onSuccess(AuthResult authResult) {
                                    ...
                                    user.setNicNumber(edtNic.getText().toString());
